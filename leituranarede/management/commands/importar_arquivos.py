...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Caminho para a pasta de erros
        erros_path = os.path.join(settings.MEDIA_ROOT, 'erros')

        # Criar a pasta de erros se não existir
                ...
                if Arquivo.objects.filter(arquivo=caminho_arquivo_db_temporario).exists():
                    ...
                    with open(file_path, 'rb') as f:
                        ...
                        try:
                            ...
                            # Mover o arquivo para a pasta de erros
                            erros_file_path = os.path.join(erros_path, filename)
                            shutil.move(file_path, erros_file_path)
                            self.stdout.write(self.style.WARNING(f'Arquivo movido para a pasta de erros.'))
